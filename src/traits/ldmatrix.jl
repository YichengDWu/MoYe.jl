...
function CopyTraits{LDSM_U32x2_N}()
    ...
    return CopyTraits{LDSM_U32x2_N}(threadid, srclayout, dstlayout)
end
...
function CopyTraits{LDSM_U16x2_T}()
    ...
    return CopyTraits{LDSM_U16x2_T}(threadid, srclayout, dstlayout)
end
...
function CopyTraits{LDSM_U16x4_T}()
    ...
    return CopyTraits{LDSM_U16x4_T}(threadid, srclayout, dstlayout)
end
...
function CopyTraits{LDSM_U16x8_T}()
    ...
    return CopyTraits{LDSM_U16x8_T}(threadid, srclayout, dstlayout)
end
